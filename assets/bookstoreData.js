...
bookstoreApp.dontWorryAboutThis = function (){
	...
	function __createBook(bookName){
		var price = Math.floor(Math.random() * 20) + 5;
...
bookstoreApp.testUser = function(name){
...
window.Bookstore = bookstoreApp.dontWorryAboutThis();

window.Kanye = bookstoreApp.testUser('Kanye');